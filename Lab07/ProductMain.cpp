...
int main(){
	...
	cout << "This program identifies prompts the user to input information for a clothing and electronic product." << endl;
	cout << "Written by Trixie Nicole Organiza" << endl;
    cout << "----------------------------------------" << endl;
